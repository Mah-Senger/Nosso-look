...
<body>
    ...
    <div id="produtos">
        <div><ion-icon name="arrow-back-circle"  class="flecha"></ion-icon></div>
        <div class="prod">
            <img src="roupas/shorts1.jpg" alt="Shorts 1" class="imagens_prod">
            <p class="descricao">Bermuda Jeans cintura alta</p>
            <p class="preco">R$ 69,99</p>
            <a href="shorts1.html" class="linkcomprar"><p class="comprar">Comprar</p></a>
        </div>
        <div class="prod">
            <img src="roupas/vestido1.jfif" alt="Vestido 1" class="imagens_prod">
            <p class="descricao">Vestido justo diversas cores</p>
            <p class="preco">R$ 59,99</p>
            <a href="" class="linkcomprar"><p class="comprar">Comprar</p></a>
        </div>
        <div class="prod">
            <img src="roupas/blusa4.jpeg" alt="Blusa 4" class="imagens_prod">
            <p class="descricao">Blusa Cetim com poá</p>
            <p class="preco">R$ 59,99</p>
            <a href="pag_blusa4.html" class="linkcomprar"><p class="comprar">Comprar</p></a>
        </div>
        <div class="prod">
            <img src="roupas/blusa1.jpeg" alt="Blusa 1" class="imagens_prod">
            <p class="descricao">Cropped tie dye colorido</p>
            <p class="preco">R$ 49,99</p>
            <a href="pag_blusa1.html" class="linkcomprar"><p class="comprar">Comprar</p></a>
        </div>
        <div class="prod">
            <img src="roupas/shorts2.jpeg" alt="Shorts 2" class="imagens_prod">
            <p class="descricao">Shorts Coloridos</p>
            <p class="preco">R$ 54,99</p>
            <a href="" class="linkcomprar"><p class="comprar">Comprar</p></a>
        </div>
        <div><ion-icon name="arrow-forward-circle"  class="flecha"></ion-icon></div>
    </div>
